...
public class MessageConst {
    ...
    public static final String PROPERTY_DELAY_TIME_IN_SECONDS = "DELAY_TIME_IN_SECONDS";
    public static final String PROPERTY_EXECUTE_TIME_IN_SECONDS = "EXECUTE_TIME_IN_SECONDS";
